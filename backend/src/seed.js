...
async function seedDatabase() {
  try {
    ...
    await Organization.create({
      ...
      description: 'مؤسسة وطنية رائدة تعنى بتقديم الدعم الغذائي، الصحي، والتعليمي للأسر العفيفة والأيتام في كافة أنحاء الأردن.',
      location: 'عمان',
      contactEmail: 'takaful@example.com',
      contactPhone: '0791234567',
      raisedFunds: 4500,
      volunteersCount: 1,
      volunteers: [user1._id],
      isActive: true,
      createdBy: admin._id,
    ...
    await Organization.create({
      name: 'مؤسسة نماء للتنمية والتعليم',
      description: 'تهدف المؤسسة إلى تمكين الشباب والمرأة اقتصادياً واجتماعياً من خلال برامج ريادية ودورات تعليمية وتأهيلية لسوق العمل.',
      location: 'إربد',
      contactEmail: 'namaa@example.com',
