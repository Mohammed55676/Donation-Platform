...
/** Retrieve a valid JWT secret from environment variables */
...
async function register(req, res, next) {
  try {
    const { name, email, password, user_type, role, phone } = req.body;
    ...
    const user = await User.create({
      ...
      password,
      role: role || 'user',
      user_type: user_type === 'beneficiary' ? 'beneficiary' : undefined,
      phone,
    });
