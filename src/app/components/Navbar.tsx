...
import { Heart, Home, Gift, Users, Menu, Moon, Sun, LogIn, LogOut, LayoutDashboard, MessageCircle, Globe, Phone, MapPin, Building } from 'lucide-react';
...
export function Navbar() {
  ...
  const navItems = [
    ...
    { name: language === 'ar' ? 'المؤسسات' : 'Organizations', path: '/organizations', icon: Building },
