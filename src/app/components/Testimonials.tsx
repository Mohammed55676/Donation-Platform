...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    name: 'محمد عبدالله',
    role: 'جمعية خيرية',
    content: 'من خلال المنصة تمكنا من الوصول إلى مئات المتبرعين وتوزيع مساعداتنا بكفاءة عالية. شراكة رائعة تجمع الخير بالعمل المنظم.',
  ...
  },
  {
    ...
    name: 'فاطمة حسن',
    role: 'متطوعة',
    content: 'تجربة التطوع عبر المنصة غيرت نظرتي للمجتمع. التنظيم ممتاز والتواصل مع المتبرعين والجمعيات الشريكة راقي جداً.',
